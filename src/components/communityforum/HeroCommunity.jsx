    ...
    <div className='py-6 px-4 mt-4'>
      ...
      <div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-10 text-xl md:text-xl'>
          ...
          <Link to={'/community-posts'}><button className='bg-blue-300 text-slate-900
                 font-bold font-serif shadow-md shadow-red-300 hover:scale-[102%]
                 transition-all  w-[50%] px-9 items-center ml-[25%] lg:ml-0  lg:px-0 lg:w-full'>Community Posts</button>
          </Link>
          ...
          <Link to={'/community-qna'}>
            <button className='bg-green-400 text-slate-900
                 font-bold font-serif shadow-md shadow-red-300 hover:scale-[102%]
                 transition-all w-[50%] px-9 items-center ml-[25%] lg:ml-0 lg:px-0 lg:w-full'>QnA Page</button>
          </Link>
