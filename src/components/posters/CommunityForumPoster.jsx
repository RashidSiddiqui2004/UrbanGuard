...
import Mobileposter1 from "/public/Mobile1.png";
import Mobileposter2 from "/public/Mobile2.png";
import desktopImage from "/public/DesktopForum.png";
            ...
            <div className='flex flex-row'>
             ...
             font-bold font-serif italic'>
                    ...
                    <Link to={'/community-forum-intro'}>
                        <button className='flex justify-center text-slate-950 bg-green-300 px-8 py-2 text-xl ml-[30%]
