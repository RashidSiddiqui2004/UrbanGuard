    ...
    return (
        <div className='text-center min-h-[300px] mt-20 merriweather overflow-hidden'>
            ...
            <motion.h1
                ...
                <span className='text-5xl -mt-2 mr-2 ml-3 md:ml-0'>❝</span>Empower
            ...
            <motion.h1
                ...
                <span className='text-5xl -mt-2 ml-2'> ❞ </span> </motion.h1>
            ...
            <div className='flex justify-center gap-8 my-8'>
                ...
                py-5 px-3 lg:px-6 shadow-md shadow-slate-500 text-xl md:text-2xl'>Register</button>
                </Link>
